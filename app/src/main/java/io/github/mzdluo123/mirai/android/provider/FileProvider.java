package io.github.mzdluo123.mirai.android.provider;
...
public class FileProvider extends DocumentsProvider {
    ...
    public boolean onCreate() {
        ...
        mBaseDir = getContext().getExternalFilesDir("");
    ...
    public Cursor queryRoots(String[] projection) throws FileNotFoundException {
        ...
        row.add(Root.COLUMN_SUMMARY, "MiraiAndroid数据文件");
        ...
        row.add(Root.COLUMN_TITLE, "MiraiAndroid");
        ...
        row.add(Root.COLUMN_ICON, R.mipmap.ic_new_launcher);
...
//        row.add(Document.COLUMN_ICON, R.drawable.ic_launcher);
    ...
    public String renameDocument(String documentId, String displayName) throws FileNotFoundException {
        ...
        File file = getFileForDocId(documentId);
        file.renameTo(new File(file.getParent(), displayName));
        return getDocIdForFile(file);
    }
